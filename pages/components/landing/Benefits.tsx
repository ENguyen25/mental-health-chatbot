    ...
    return (
        <div className="main-container flex flex-col items-center">
            ...
            <div className="w-full lg:w-[1000px] ">
                <div className="mb-20 flex flex-col gap-8 items-center lg:mb-16 lg:flex-row lg:justify-between lg:gap-16">
                    <div className="w-full sm:w-fit lg:w-1/3">
                ...
                <div className="flex flex-col gap-8 items-center lg:flex-row lg:justify-between lg:gap-16">
                    <div className="w-full sm:w-fit lg:w-1/3">
